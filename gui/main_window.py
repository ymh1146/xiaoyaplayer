...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.connect_btn.setFixedWidth(60) # 固定宽度
        ...
        search_btn.setFixedWidth(60) # 固定宽度，与连接按钮一致
        ...
        # 移除头部下方的分割线（通过样式表控制，或者隐藏header）
        self.tree.header().setVisible(False) # 如果不需要"文件列表"标题，可以隐藏
